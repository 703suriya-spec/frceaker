...
async def check_card_msh(
    ...
    if "ORDER_PLACED" in msg_upper or "PROCESSEDRECEIPT" in msg_upper or "ORDER PLACED" in clean_upper or "CHARGE_SUCCESS" in msg_upper:
    ...
    if "TIMEOUT" in msg_upper:
        return "declined", "Gateway Timeout (Site Busy)", gateway_str
