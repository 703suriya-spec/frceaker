...
async def charge_payment_page_card_async(
    page_url: str,
    cc: str,
    month: str,
    year: str,
    ...
    dbg: dict[str, Any] = {"hosted_api": True, "http_status": status_code, "site": site}

    if not text:
        return "unknown", f"empty_response_http_{status_code}", "empty", dbg
