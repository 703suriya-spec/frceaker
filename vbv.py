...
async def check_card_str_async(cc_str: str, timeout: float = 55.0) -> tuple[str, str, str, dict[str, Any]]:
    """
    ...
    if not text:
        return "Error", f"empty_response_http_{dbg.get('http_status')}", "empty", dbg
